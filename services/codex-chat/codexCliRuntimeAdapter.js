...
function newSessionArgs(toolContext = null, controlledMcp = null) {
  return [
    'exec',
    '--json',
    ...REASONING_CONFIG,
...
function resumeArgs(sessionId, toolContext = null, controlledMcp = null) {
  return [
...
export class CodexCliRuntimeAdapter {
  ...
  startOrResume({ sessionId = null, toolContext = null, controlledMcp = null } = {}) {
    return {
      session_id: sessionId,
      resumed: Boolean(sessionId),
      args: sessionId ? resumeArgs(sessionId, toolContext, controlledMcp) : newSessionArgs(toolContext, controlledMcp),
    }
  }
  ...
  async #run({
    ...
    try {
      ...
      command = this.startOrResume({ sessionId, toolContext, controlledMcp })
